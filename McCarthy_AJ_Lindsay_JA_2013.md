...
To download Assembly files, we used Batch Entrez(https://www.ncbi.nlm.nih.gov/sites/batchentrezand) and used the list of Accession numbers as the input file.
